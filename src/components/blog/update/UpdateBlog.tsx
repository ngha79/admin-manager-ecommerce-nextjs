...
import { createBlog, getListTopicBlog, updateBlog } from "@/utils/actions/blog";
import {
  Select,
  SelectContent,
  SelectGroup,
...
const UpdateBlog = ({ blog }: { blog: TBlog }) => {
  ...
  const onSubmit = async (data: TBlogValidator) => {
    startTransition(async () => {
      try {
        await updateBlog(blog.id, { ...data, description: content });
        await reFetchBlog();
    ...
    <div className="container py-4 space-y-4">
      ...
      <form action="" className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input
            disabled={isLoading}
            {...register("author", { value: blog.author })}
        ...
        <div className="flex flex-col gap-2">
          ...
          <Select
            ...
            defaultValue={blog.topic.topic}
            {...register("topic", { value: blog.topic.id })}
          >
